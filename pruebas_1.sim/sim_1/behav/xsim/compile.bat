...
REM
REM Generated by Vivado on Fri Jun 26 19:30:53 +0200 2026
...
echo "xvhdl --incr --relax -prj CronometroAll_tb_vhdl.prj"
call xvhdl  --incr --relax -prj CronometroAll_tb_vhdl.prj -log xvhdl.log
